...
//    ofSetColor( ofColor(0, 0, ofRandom( 128, 255 ) );
    ...
    ofTranslate(x,y, depth1layer);
    vector < ofPath > paths1 = font.getStringAsPoints("MEMORY OF ");
    ...
    ofRotateYDeg(180);
    ofScale(1,-1); // (1,-1) This flips the Y axis and solves the problem created by the for loop
    ofTranslate(x,y, depth2layer);
    vector < ofPath > paths6 = font.getStringAsPoints("MEMORY OF ");
    ...
    ofRotateYDeg(180);
    ofScale(1,-1); // (1,-1) This flips the Y axis and solves the problem created by the for loop
    ofTranslate(x,y, depth3layer);
    vector < ofPath > paths10 = font.getStringAsPoints("MEMORY OF ");
    ...
    //TOP word
     //    //BOTTON word
        ...
        ofRotateXDeg(536);
        ofScale(1,-1);
        ofTranslate(x,y, depth3layer); // same as above but Y inverted
        vector < ofPath > paths11 = font.getStringAsPoints("EVERYWHERE");
        ...
        ofRotateXDeg(536);
        ofScale(1,-1);
        ofTranslate(x,y, depth2layer); // same as above but Y inverted
        vector < ofPath > paths7 = font.getStringAsPoints("EVERYWHERE");
        ...
        //    //BOTTON word
            ...
            ofPushMatrix();
                ofRotateXDeg(536);
                    ofScale(1,-1);
                    ofTranslate(x,y, depth1layer); // same as above but Y inverted
                    vector < ofPath > paths = font.getStringAsPoints("EVERYWHERE");
...
//    vector < ofPath > paths10 = font.getStringAsPoints("MEMORY");
//    for (int i = 0; i  < paths10.size(); i++){
//        paths10[i].draw();
//    }
//    ofPopMatrix();
...
//    vector < ofPath > paths12 = font.getStringAsPoints("EVERYWHERE");
...
//    ofScale(1.1,-1.1);
//    ofTranslate(x3layerWindows,y3layerWindows, depth3layer); // same as above but Y inverted
//    vector < ofPath > paths13 = font.getStringAsPoints("EVERYWHERE");
...
//    vector < ofPath > paths8 = font.getStringAsPoints("MEMORY");
...
//    ofScale(1.24,-1.24);
//    ofTranslate(x2layerBeyond,y2layerBeyond, depth2layer); // same as above but Y inverted
//    vector < ofPath > paths9 = font.getStringAsPoints("MEMORY");
...
//                vector < ofPath > paths1 = font.getStringAsPoints("MEMORY");
//                for (int i = 0; i  < paths1.size(); i++){
//                    paths1[i].draw();
//                }
//        ofPopMatrix();
...
//                vector < ofPath > paths = font.getStringAsPoints("MEMORY");
//                for (int i = 0; i  < paths.size(); i++){
//                    paths[i].draw();
//                }
//        ofPopMatrix();
...
//            vector < ofPath > paths3 = font.getStringAsPoints("EVERYWHERE");
...
//                ofScale(1,-1);
//                ofTranslate(x1layerWindows,y1layerWindows, depth1layer); // same as above but Y inverted
//                vector < ofPath > paths4 = font.getStringAsPoints("EVERYWHERE");
